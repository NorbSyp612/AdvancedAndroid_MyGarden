...
import static com.example.android.mygarden.PlantWidgetProvider.updateAppWidget;
...
public class PlantWateringService extends IntentService {
    ...
    public static final String ACTION_UPDATE_PLANT_WIDGETS = "com.example.mygarden.action.update_plant_widgets";
    ...
    private void handleUpdateWater() {
        Uri PLANTS_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_PLANTS).build();
